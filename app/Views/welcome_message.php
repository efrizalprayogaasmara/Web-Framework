...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="<?=base_url()?>/assets/https://codeigniter.com" target="_blank">
            ...
            <li class="menu-item hidden"><a href="<?=base_url()?>/assets/#">Home</a></li>
            <li class="menu-item hidden"><a href="<?=base_url()?>/assets/https://codeigniter.com/user_guide/" target="_blank">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="<?=base_url()?>/assets/https://forum.codeigniter.com/" target="_blank">Community</a></li>
            <li class="menu-item hidden"><a
                    href="<?=base_url()?>/assets/https://codeigniter.com/contribute" target="_blank">Contribute</a>
            </li>
        </ul>
    </div>
...
<div class="further">
    ...
    <section>
        ...
        <p>The User Guide contains an introduction, tutorial, a number of "how to"
            ...
            the framework. Check the <a href="<?=base_url()?>/assets/https://codeigniter.com/user_guide/"
        ...
        <p>CodeIgniter is a community-developed open source project, with several
             ...
             the threads on <a href="<?=base_url()?>/assets/https://forum.codeigniter.com/"
             target="_blank">CodeIgniter's forum</a>, or <a href="<?=base_url()?>/assets/https://join.slack.com/t/codeigniterchat/shared_invite/zt-rl30zw00-obL1Hr1q1ATvkzVkFp8S0Q"
        ...
        <p>CodeIgniter is a community driven project and accepts contributions
             ...
             <a href="<?=base_url()?>/assets/https://codeigniter.com/contribute" target="_blank">
             join us</a> ?</p>
